	...
	public static async Task GenerateAsync()
	{
						...
						if (typeof(T) == typeof(global::Domains.Description))
						{
							switch(typeIdentifiers[typeIdentifiersIndex])
							{
								case 0:
									...
									return (global::Domains.Description)(null as string)!;
								default:
		...
		var writerExtensionsCode =
			...
			internal static class GeneratorFormatterWriterContextExtensions
			{
				...
				{
					public void WriteUnion(global::Domains.Description value, global::System.Collections.Generic.List<byte> typeIdentifiers)
					{
						switch(value)
						{
							case string u0:

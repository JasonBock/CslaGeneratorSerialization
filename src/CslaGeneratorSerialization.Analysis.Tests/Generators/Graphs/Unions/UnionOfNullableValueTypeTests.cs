...
internal static class UnionOfNullableValueTypeTests
{
	[Test]
	...
	[Test]
	public static async Task GenerateWithNoNullCheckAsync()
	{
		var code =
			"""
			using Csla;
			...
			public union Identifier(int, Guid);

...
## [3.0.0-alpha.3] - 2026-09-20

### Fixed
* Altered definition of `IsNullable` based on `UnionCaseTypes` values (issue [#55](https://github.com/JasonBock/CslaGeneratorSerialization/issues/55))

## [3.0.0-alpha.2] - 2026-09-05
...
### Added
* Added support for `BusinessDocumentBase` (issue [#44](https://github.com/JasonBock/CslaGeneratorSerialization/issues/44))

## [2.1.1] - 2026-02-23

### Fixed
* `Deserialized()` is now called on any object that implements `ISerializationNotification` (issue [#43](https://github.com/JasonBock/CslaGeneratorSerialization/issues/43))
